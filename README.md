...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-09-20 18:40`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/1a94f707-c1e3-4829-a289-a580c10310a6.git
$ cd 1a94f707-c1e3-4829-a289-a580c10310a6
```
